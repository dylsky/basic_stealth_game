...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSCharacter()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_NoiseEmitterComp_MetaData[] = {
				{ "Category", "AI" },
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/FPSCharacter.h" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_NoiseEmitterComp = { UE4CodeGen_Private::EPropertyClass::Object, "NoiseEmitterComp", RF_Public|RF_Transient|RF_MarkAsNative, 0x00200800000a001d, 1, nullptr, STRUCT_OFFSET(AFPSCharacter, NoiseEmitterComp), Z_Construct_UClass_UPawnNoiseEmitterComponent_NoRegister, METADATA_PARAMS(NewProp_NoiseEmitterComp_MetaData, ARRAY_COUNT(NewProp_NoiseEmitterComp_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_NoiseEmitterComp,
	...
	IMPLEMENT_CLASS(AFPSCharacter, 4285673153);
