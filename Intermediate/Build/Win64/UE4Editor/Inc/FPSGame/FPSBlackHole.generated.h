...
#define StealthGame_Source_FPSGame_Public_FPSBlackHole_h_15_RPC_WRAPPERS \
 \
	...
	{ \
		P_GET_OBJECT(UPrimitiveComponent,Z_Param_OvelappingComponent); \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->OverlapInnerSphere(Z_Param_OvelappingComponent,Z_Param_OtherActor,Z_Param_OtherComponent,Z_Param_OtherBodyIndex,Z_Param_bFromSweep,Z_Param_Out_SweepResult); \
		P_NATIVE_END; \
	}
...
#define StealthGame_Source_FPSGame_Public_FPSBlackHole_h_15_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__StaticFx() { return STRUCT_OFFSET(AFPSBlackHole, StaticFx); }
